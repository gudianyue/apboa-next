 ...
 **/
@Component
public class AllowExcelUploadFile implements ParamsCore {
    @Override
    ...
    public String getDefaultValue() {
        return SysConst.ALLOW_EXCEL_FILE_TYPE;
    }

    @Override
    public void register(ParamsAdapter adapter) {
        adapter.register("ALLOW_EXCEL_FILE_TYPE", new AllowExcelUploadFile());
    }
}
