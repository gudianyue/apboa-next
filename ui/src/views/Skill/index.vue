...
const toolLinkSkillId = ref<string>('')
 ...
 * 处理关联工具
 */
function handleToolLink(id: string) {
  toolLinkSkillId.value = id
  toolLinkVisible.value = true
}
 ...
 * 处理关联工具成功
 */
function handleToolLinkSuccess() {
  resetListAndRebuild()
}
