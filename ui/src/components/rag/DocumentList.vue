  ...
  <div class="doc-list-container">
    ...
    <div class="doc-list-toolbar">
      <div class="doc-list-toolbar-left">
        ...
        >
          <AButton type="primary" :loading="uploading" v-permission="['TENANT_EDITOR','TENANT_ADMIN','TENANT_OWNER']">
            <UploadOutlined /> 上传文档
          </AButton>
        </AUpload>
    ...
    <div v-if="filteredDocuments.length === 0 && !loading" class="doc-empty">
      ...
      <AUpload
        ...
        accept=".pdf,.txt,.docx,.doc,.xlsx,.xls,.md,.csv,.pptx,.ppt"
      >
        <AButton type="primary" v-permission="['TENANT_EDITOR','TENANT_ADMIN','TENANT_OWNER']">上传第一个文档</AButton>
      </AUpload>
    </div>
