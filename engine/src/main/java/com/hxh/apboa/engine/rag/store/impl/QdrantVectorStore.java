...
public class QdrantVectorStore implements VectorStore {
    ...
    public void storeEmbedding(Long id, Long chunkId, Long documentId,
        ...
        Points.PointStruct point = Points.PointStruct.newBuilder()
                ...
                .putPayload("tenant_id", value(tenantId))
                .build();
    ...
    public void storeEmbeddings(List<EmbeddingRecord> records) {
        ...
        for (EmbeddingRecord record : records) {
            ...
            Points.PointStruct point = Points.PointStruct.newBuilder()
                    .setId(id(record.id()))
                    .setVectors(vectors(record.embedding()))
                    .putPayload("chunk_id", value(record.chunkId()))
                    .putPayload("document_id", value(record.documentId()))
                    .putPayload("knowledge_base_config_id", value(record.knowledgeBaseConfigId()))
                    .putPayload("tenant_id", value(tenantId))
                    .build();
